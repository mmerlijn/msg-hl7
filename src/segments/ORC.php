...
class ORC extends Segment implements SegmentInterface
{
    ...
    public function getMsg(Msg $msg): Msg
    {
        ...
        $msg->order->organization->setPhone($this->getData(23));
    ...
    public function setOrder(Msg $msg, int $nr = 0): self
    {
        //order controle
        $this->setData($msg->order->control->getHl7(), 1);
        $this->setData($msg->order->requests[$nr]?->id ?: $msg->order->request_nr, 2);
        //requestnr
